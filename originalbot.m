function [turnsToWin, hitPointsBot_unique, missedPointsBot, botname, allPointsBot] = originalbot(occupiedPoints,ship1,ship2,ship3,ship4,ship5)
%original bot chooses random points until a hit, then uses human strategy
